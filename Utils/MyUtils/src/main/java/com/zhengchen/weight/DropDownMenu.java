...
import com.yanxuwen.myutils.Utils.DensityUtil;
import com.zhengchen.R;
import com.zhengchen.Utils.DeviceUtils;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DensityUtil.dip2px(context, 50f));
        tabMenuView.setOrientation(HORIZONTAL);
        tabMenuView.setGravity(Gravity.RIGHT|Gravity.CENTER_VERTICAL);
        tabMenuView.setBackgroundColor(menuBackgroundColor);
        tabMenuView.setPadding(0,0,dpTpPx(20),0);
...
//        //添加点击事件
        ...
        imageView.setImageResource(R.mipmap.btn_classify);
//        imageView.setPadding(dpTpPx(20),dpTpPx(14),dpTpPx(0),dpTpPx(20));
//        imageView.set
