package com.yanxuwen.module_bottomtab3.debug

import android.os.Bundle
import com.yanxuwen.lib_common.Base.BaseActivity
import com.yanxuwen.lib_common.Bean.Value
import com.yanxuwen.module_bottomtab3.Main.BottomTab3Fragment
...
class MainActivity : BaseActivity(){
    ...
    var f1: BottomTab3Fragment?=null
    private fun initFragment(){
        var transaction = supportFragmentManager.beginTransaction()
        //第一种方式（add），初始化fragment并添加到事务中，如果为null就new一个
        if(f1 == null){
            f1 = BottomTab3Fragment::class.java.newInstance()
