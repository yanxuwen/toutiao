...
import static com.yanxuwen.lib_common.ARouter.MyARouter.logger;
...
public class LogisticsCenter {
    ...
    private static void loadRouterMap() {
        ...
        // looks like below:
        // registerRouteRoot(new MyARouter..Root..modulejava());
        // registerRouteRoot(new MyARouter..Root..modulekotlin());
    }
    ...
    public synchronized static void init(Context context, ThreadPoolExecutor tpe) throws HandlerException {
        ...
        try {
            ...
            if (registerByPlugin) {
                ...
                if (MyARouter.debuggable() || PackageUtils.isNewVersion(context)) {
            ...
            if (MyARouter.debuggable()) {
                logger.debug(TAG, String.format(Locale.getDefault(), "LogisticsCenter has already been loaded, GroupIndex[%d], InterceptorIndex[%d], ProviderIndex[%d]", Warehouse.groupsIndex.size(), Warehouse.interceptorsIndex.size(), Warehouse.providersIndex.size()));
            }
        } catch (Exception e) {
            throw new HandlerException(TAG + "MyARouter init logistics center exception! [" + e.getMessage() + "]");
        }
    }
        ...
        if (null == routeMeta) {    // Maybe its does't exist, or didn't load.
            ...
            if (null != rawUri) {   // Try to set params into bundle.
                ...
                if (MapUtils.isNotEmpty(paramsType)) {
                    ...
                    postcard.getExtras().putStringArray(MyARouter.AUTO_INJECT, paramsType.keySet().toArray(new String[]{}));
                }

                // Save raw uri
                postcard.withString(MyARouter.RAW_URI, rawUri.toString());
            }
