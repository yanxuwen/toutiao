package com.yanxuwen.lib_common.Utils.Divider;
...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration(Context context, @Orientation int orientation,int Drawable) {
//        resolveDivider(context);
        mVerticalDivider = mHorizontalDivider = context.getResources().getDrawable(Drawable);
