...
public final class Postcard extends RouteMeta {
    ...
    public Object navigation(Context context, NavigationCallback callback) {
        return MyARouter.getInstance().navigation(context, this, -1, callback);
    }
    ...
    public void navigation(Activity mContext, int requestCode, NavigationCallback callback) {
        MyARouter.getInstance().navigation(mContext, this, requestCode, callback);
    }
    ...
    public Postcard withObject(@Nullable String key, @Nullable Object value) {
        serializationService = MyARouter.getInstance().navigation(SerializationService.class);
