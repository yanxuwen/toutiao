...
import com.yanxuwen.Base.MPagerAdapter;
 ...
 * 用阿里路由解析Fragemnt
 */
public class MyPagerAdapter extends MPagerAdapter {
    private List<String> list_fragment;
    public MyPagerAdapter(FragmentManager fm, List<String> list_fragment, List<String> list_title) {
        super(fm);
